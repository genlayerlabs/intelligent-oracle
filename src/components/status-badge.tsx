  ...
  const className = lower.includes("resolved")
    ...
    : lower.includes("error") || lower.includes("fail")
      ...
      : lower.includes("pending")
        ? "border-amber-500/30 bg-warning-soft text-amber-700"
        : "border-[color:var(--brand-blue)]/20 bg-[color:color-mix(in_oklab,var(--brand-blue)_8%,transparent)] text-[color:var(--brand-blue)]";
